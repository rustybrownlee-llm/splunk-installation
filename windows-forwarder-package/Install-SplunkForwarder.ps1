...
$ProjectInstallerPath = Join-Path $ScriptRoot $InstallerFilename
...
try {
    ...
    # Check for installer in package folder
    if (Test-Path $ProjectInstallerPath) {
        Write-ColorOutput "Found installer in package folder" "INFO"
        ...
        Write-ColorOutput "Installer not found in package folder" "ERROR"
